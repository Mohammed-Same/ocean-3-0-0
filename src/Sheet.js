...
const Sheet = () => {
  ...
  console.log(selectedSheet?.row?.key);
      ...
      <div className="third-line">
        ...
        <div className="graph">
          ...
          <div
            ...
            id="row"
          >
            {sheets.find((sheet) => sheet.name === sheetParam) &&
